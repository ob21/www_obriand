    ...
    public function handle(Request $request): Response
    {
        ...
        if (!isset($_SESSION['username']) || !$_SESSION['username']) {
            ...
            if ($authenticationMode == 'required') {
                $response = $this->responder->error(ErrorCode::AUTHENTICATION_REQUIRED, '$_SESSION[\'username\'] is empty');
...
$config = new Config([
    'username' => 'obrianddata',
    'password' => 'Belierdata00',
    'database' => 'obrianddata',
    'address' => 'obrianddata.mysql.db',
    'driver' => 'mysql'
]);
$request = new Request();
$api = new Api($config);
